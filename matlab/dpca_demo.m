...
%     trialNum = randi([5 E], [N S D]); %if you don't have simulataneous recordings
% else
...
save('C:\Users\mld9131\Documents\GitHub\dPCA\matlab\OFC_COFF_weights.mat','W','V','whichMarg');
