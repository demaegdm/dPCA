function [W,V] = dPCA_MD(FR_control,time,trialNum,savename,savename2,FR_opto,trials2)
% firingRates
% time
% trialNum
...
dpca_plot(FR_control_mean, W, V, @dpca_plot_default, ...
    'explainedVar', explVar, ...
    'marginalizationNames', margNames, ...
    'marginalizationColours', margColours, ...
    'whichMarg', whichMarg,                 ...
...
dpca_plot(FR_opto_mean, W, V, @dpca_plot_default, ...
    'explainedVar', explVar, ...
    'marginalizationNames', margNames, ...
    'marginalizationColours', margColours, ...
    'whichMarg', whichMarg,                 ...
...
save(['C:\Users\mld9131\Documents\GitHub\dPCA\matlab\' savename '.mat'],'W','V','whichMarg');
